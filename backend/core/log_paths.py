...
LOGS_WORKSHOP_FRIDA_SESSIONS = LOGS_WORKSHOP_FRIDA / "sessions"
LOGS_WORKSHOP_CATEGORIZATION = LOGS_WORKSHOP / "categorization"
LOGS_WORKSHOP_ERRORS = LOGS_WORKSHOP / "errors"
LOGS_WORKSHOP_OPERATIONS = LOGS_WORKSHOP / "operations"

# Instrumentation logs
LOGS_INSTRUMENTATION = LOGS_ROOT / "instrumentation"
LOGS_INSTRUMENTATION_OBSERVER = LOGS_INSTRUMENTATION / "observer"
...
def ensure_log_directories():
    ...
    LOGS_WORKSHOP_FRIDA_SESSIONS.mkdir(parents=True, exist_ok=True)
    LOGS_WORKSHOP_CATEGORIZATION.mkdir(parents=True, exist_ok=True)
    LOGS_WORKSHOP_ERRORS.mkdir(parents=True, exist_ok=True)
    LOGS_WORKSHOP_OPERATIONS.mkdir(parents=True, exist_ok=True)
    LOGS_INSTRUMENTATION.mkdir(parents=True, exist_ok=True)
    LOGS_INSTRUMENTATION_OBSERVER.mkdir(parents=True, exist_ok=True)
